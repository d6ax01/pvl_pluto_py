...
# motor ===============================================
gMotor = -1
#motion_dist500 = 418   # 3m 실거리 -> 2023_02_21, 차트 ~ 모듈 바닥 -> 500mm에서 521.6mm(418)
motion_dist500 = 65     # ismedia -> 2023_02_22, 차트 ~ 모듈 바닥 -> 500mm에서 521.6mm(65)

#motion_dist300 = 215   # 3m 실거리 -> 2023_02_17, 차트 ~ 안착지그 덮개 -> 300mm에서 299.87mm(192.77)
motion_dist300 = 278    # ismedia -> 2023_02_22, 차트 ~ 모듈 바닥 -> 500mm에서 521.6mm(65)
...
gSaveModulePath = f' '
g100MHzSetFileName = f'100M_1109.set'  # 검증3차 -> f'100M_1109.set'
g20MHzSetFileName = f'20M_1109.set'  # 검증3차 -> f'20M_1109.set'
