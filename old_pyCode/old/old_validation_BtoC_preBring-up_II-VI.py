...
def find_judge(mode, freq, data, indexCount):
    ...
    DepthErrorAVG300_Spec_Center = 100.0  # //300mm Depth Validation Data_f1 -> Depth mean of center ROI
    ...
    DepthErrorAVG500_Spec_Center = 100.0;  # 500mm Depth Validation Data_f1 (QVGA) -> Depth mean of center ROI
    DepthErrorAVG500_Spec_06Field = 100.0;  # 500mm Depth Validation Data_f1 (QVGA) -> Depth mean of 0.6F ROI
    ...
    DepthNoiseAVG500_Spec_Center = 100.0;  # 500mm Depth Validation Data_f1 (QVGA) -> Validation Noise of center ROI
    DepthNoiseAVG500_Spec_06Field = 100.0;  # 500mm Depth Validation Data_f1 (QVGA) -> Validation Noise of 0.6F ROI
