...
if __name__ == "__main__":
    pos = 300 # 차트와 모듈의 간격
    motor = 195.5 # pos 값을 위해서 이동해야하는 모터 값
    ...
    if (want_home_position_at_start):
        ...
        motor_move(distance=pos, motion_abs=motor)  # 2022_11_30, 지그교체
        time.sleep(0.5)
    ...
    # 20 MHz 저장 *****************************************************************
    Measurement(20, pos, motor)  # 2900 mm 에서 평가
    ProcCreateReport(1)  # 0 -> find global offset , 1 -> only measurement
